        ...
        <div class="container">
            ...
            <div class="header-actions">
                ...
                <button class="action-btn" aria-label="cart">
                    ...
                    <span class="btn-badge">2006</span>
                </button>
            ...
            <ul class="has-scrollbar">
                ...
                <li class="scrollbar-item">
                    <div class="brand-card img-holder" style="--width: 150; --height: 150;">
                        <img src="./assets/images/brand-1.jpg" width="150" height="150" loading="lazy"
                ...
                <li class="scrollbar-item">
                    <div class="brand-card img-holder" style="--width: 150; --height: 150;">
                        <img src="./assets/images/brand-3.jpg" width="150" height="150" loading="lazy"
                            alt="brand logo" class="img-cover">
                    </div>
                </li>
                ...
                <li class="scrollbar-item">
                    <div class="brand-card img-holder" style="--width: 150; --height: 150;">
                        <img src="./assets/images/brand-4.jpg" width="150" height="150" loading="lazy"
                            alt="brand logo" class="img-cover">
                    </div>
                </li>
                ...
                <li class="scrollbar-item">
                    <div class="brand-card img-holder" style="--width: 150; --height: 150;">
                        <img src="./assets/images/brand-5.jpg" width="150" height="150" loading="lazy"
                            alt="brand logo" class="img-cover">
                    </div>
                    =======
                    <!--
                    ...
                    <section class="section brand" aria-label="brand">
                        <div class="container">
                            ...
                            <ul class="has-scrollbar">
                                ...
                                <li class="scrollbar-item">
                                    <div class="brand-card img-holder" style="--width: 150; --height: 150;">
                                        <img src="./assets/images/brand-1.jpg" width="150" height="150"
                                ...
                                <li class="scrollbar-item">
                                    <div class="brand-card img-holder" style="--width: 150; --height: 150;">
                                        <img src="./assets/images/brand-2.jpg" width="150" height="150"
                                            loading="lazy" alt="brand logo" class="img-cover">
                                    </div>
                                </li>
                                ...
                                <li class="scrollbar-item">
                                    <div class="brand-card img-holder" style="--width: 150; --height: 150;">
                                        <img src="./assets/images/brand-3.jpg" width="150" height="150"
                                            loading="lazy" alt="brand logo" class="img-cover">
                                    </div>
                                </li>
                                ...
                                <li class="scrollbar-item">
                                    <div class="brand-card img-holder" style="--width: 150; --height: 150;">
                                        <img src="./assets/images/brand-4.jpg" width="150" height="150"
                                            loading="lazy" alt="brand logo" class="img-cover">
                                    </div>
                                </li>
                                ...
                                <li class="scrollbar-item">
                                    <div class="brand-card img-holder" style="--width: 150; --height: 150;">
                                        <img src="./assets/images/brand-5.jpg" width="150" height="150"
                                            loading="lazy" alt="brand logo" class="img-cover">
                                    </div>
                                </li>
                        ...
                        <div class="footer-top section">
                            <div class="container">
                                ...
                                <div class="footer-brand">
                                    ...
                                    <p class="footer-text">
                                        If you have any question, please contact us at <a href="#"
                                    ...
                                    <ul class="contact-list">
                                        ...
                                        <li class="contact-item">
                                            ...
                                            <address class="address">
                                                Jl. Rajawali Raya No.6, RT.3/RW.11, Halim Perdana Kusumah, Kec. Makasar,
                                ...
                                <footer class="footer" style="background-image: url('./assets/images/footer-bg.jpg')">
                                            ...
                                            <div class="footer-brand">
                                                ...
                                                <ul class="contact-list">
                                                    ...
                                                    <li class="contact-item">
                                                        ...
                                                        <address class="address">
                                                            Jl. Rajawali Raya No.6, RT.3/RW.11, Halim Perdana Kusumah,
                                                            Kec. Makasar, Kota Jakarta
                                                            Timur, Daerah Khusus Ibukota Jakarta 13610
                                                        </address>
                                                    </li>
                                    ...
                                    <div class="footer-bottom">
                                        <div class="container">
                                            ...
                                            <p class="copyright">
                                                &copy; 2006 Made with ♥ by <a href="#"
                                                    class="copyright-link">GENDHUT</a>
                                            </p>

                                            <img src="./assets/images/payment.png" width="397" height="32"
